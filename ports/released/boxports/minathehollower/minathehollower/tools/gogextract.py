#!/usr/bin/env python3
# Vendored from https://github.com/Yepoleb/gogextract (MIT License,
# Copyright (c) 2016 Gabriel Huber). Splits a GOG Linux MojoSetup
# installer (.sh) into its component parts; we only consume "data.zip".
import io
import re
import shutil
import os
