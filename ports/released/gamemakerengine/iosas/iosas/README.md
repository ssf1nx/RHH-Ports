...
The Steam version is currently incompatible with gmtoolkit and so patching skips many steps. Due to this the port is currently only fit for 2GB+ devices.
