...
This wrapper is made for linux handhelds to run Dusk, an unofficial PC port of *The Legend of Zelda: Twilight Princess*. You must provide your own legally-obtained game files.

## Hardware Requirements

Dusk is built on the **Aurora** framework, which only ships **Vulkan, Metal, and D3D12** backends. **There is no OpenGL or OpenGL ES backend.** Your handheld must have a working Vulkan driver:
...
TwilitRealm - The Dusk decomp/reimplementation  
